...
var firebase = (function() { var l="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){if(c.get||c.set)throw new TypeError("ES3 does not support getters and setters.");a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)},m="undefined"!=typeof window&&window===this?this:"undefined"!=typeof global&&null!=global?global:this,n=function(){n=function(){};m.Symbol||(m.Symbol=p)},q=0,p=function(a){return"jscomp_symbol_"+(a||"")+q++},u=function(){n();var a=m.Symbol.iterator;a||(a=m.Symbol.iterator=m.Symbol("iterator"));
"function"!=typeof Array.prototype[a]&&l(Array.prototype,a,{configurable:!0,writable:!0,value:function(){return r(this)}});u=function(){}},r=function(a){var b=0;return v(function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}})},v=function(a){u();a={next:a};a[m.Symbol.iterator]=function(){return this};return a},w=function(a){u();var b=a[Symbol.iterator];return b?b.call(a):r(a)},x=function(a,b){if(b){var c=m;a=a.split(".");for(var d=0;d<a.length-1;d++){var e=a[d];e in c||(c[e]={});c=c[e]}a=a[a.length-
...
a.h(b.resolve,b.reject)};d.prototype.$=function(a,b){var c=this.j();try{a.call(b,c.resolve,c.reject)}catch(k){c.reject(k)}};d.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{k(a(b))}catch(Q){e(Q)}}:b}var k,e,g=new d(function(a,b){k=a;e=b});this.h(c(a,k),c(b,e));return g};d.prototype.catch=function(a){return this.then(void 0,a)};d.prototype.h=function(a,b){function c(){switch(d.g){case 1:a(d.v);break;case 2:b(d.v);break;default:throw Error("Unexpected state: "+
...
typeof c.metadata)return c.metadata(a,b)},__param=function(a,b){return function(c,d){b(c,d,a)}},__awaiter=function(a,b,c,d){return new (c||(c=Promise))(function(e,g){function h(a){try{k(d.next(a))}catch(t){g(t)}}function f(a){try{k(d["throw"](a))}catch(t){g(t)}}function k(a){a.done?e(a.value):(new c(function(b){b(a.value)})).then(h,f)}k((d=d.apply(a,b)).next())})},__generator=function(a,b){function c(a){return function(b){return d([a,b])}}function d(c){if(g)throw new TypeError("Generator is already executing.");
